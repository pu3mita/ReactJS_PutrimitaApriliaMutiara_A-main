  ...
  return (
    <nav className='grid grid-cols-3 justify-between px-24 py-4 bg-[#8091FF] items-center'>
        ...
        <ul className='flex justify-center items-center'>
          <li className='w-full'>
            <input onChange={(e) => props.onInput(e)} type="text" className='text-black active:text-black focus:text-black px-4 py-2 w-full' name="search" id={inputId} placeholder='Search product...' />
          </li>
        </ul>
        {!isLoggedIn ? (
